...
public class Consulta{
   ...
   private List<ConsultaFiltro> filtros;
    ...
    public void setConsultaCampos(List<ConsultaCampo> consultaCampos) {
     ...
     public List<ConsultaFiltro> getConsultaFiltros() {
        return filtros;
    }

    public void setConsultaFiltros(List<ConsultaFiltro> consultaFiltros) {
        this.filtros = consultaFiltros;
    }
